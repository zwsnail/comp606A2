		...
		<div class="row">
			<div class="col-lg-4 offset-lg-4 bg-light rounded" id="register-box">
				...
				<form action="include/customer_edit_job.inc.php?job_id=<?php echo $job_id?>" method="post" role="form" class="p-2" id="register-frm">
					...
					<textarea name="description" class="form-control"  aria-label="With textarea"><?php echo $job_description;?></textarea>
					</div>

					<div class="form-group">
                    <p>What is the date when job will be active?</p>
						<input type="date" name="start" class="form-control"  value="<?php echo $job_start_date;?>" required>
					</div>
					<div class="form-group">
                    <p>What is the date when request for estimates finishes?</p>
						<input type="date" name="expire" class="form-control" value="<?php echo $job_expire_date;?>"  required>
					</div>
					<div class="form-group">
